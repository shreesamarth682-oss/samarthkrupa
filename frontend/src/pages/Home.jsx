    ...
    <div className="home-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <button onClick={() => (window.location.href = "tel:9404992788")}>
            📞 Call Us Now
          </button>
        </div>
      </section>
        ...
        <div className="about-inner">
          ...
          <div className="about-text">
            ...
            <p>
              ...
              We are an <b>Exclusive Ultratech Cement Wholesale Dealer</b> and also supply
              <b> T.M.T Steel (Shree Om)</b>.
              <br /><br />
              Branches available in <b>Khed</b> and <b>Chiplun</b>.
              <br /><br />
      ...
      <section className="home-products">
        ...
        <div className="product-grid">
          ...
          <div className="product-card">
            ...
            <h3>Tiles 4 X 2 & Marble (Kiyan, Style, Cryamik)</h3>
          </div>
          <div className="product-card">
      ...
      <section className="why-choose">
        ...
        <div className="why-grid">
          <div className="why-card">
            ...
            <p>Supplying to Shops, and construction projects across Mandangad.</p>
          </div>
          <div className="why-card">
      ...
      <section className="contact-cta">
        ...
        <p>
          📍 Near Babasaheb Ambedkar High School, <b>Shivaji Nagar</b>, Mandangad, Dist. Ratnagiri — 415203 <br />
          ☎️ 02350 225682 / 225957 / 225532 <br />
          📱 9404992788 / 8888172675 / 9657033788 <br />
          📧 <a href="mailto:shreesamarth788@gmail.com" style={{ color: "white", textDecoration: "none", fontWeight: "bold" }}>shreesamarth788@gmail.com</a> <br />
          🧾 GST No: <b>27AHCPG4866FI2D</b>
        </p>
